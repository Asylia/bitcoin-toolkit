...
- Stable Trezor adapter for Connect initialization, browser environment
  checks, xpub export, P2WSH multisig address display, live device events,
  and PSBT signing through `@asylia/btc-core`.
